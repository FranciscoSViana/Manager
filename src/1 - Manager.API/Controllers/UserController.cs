    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get(long id)
        {
            try
            {
                ...
                if (user == null) {
                    return Ok(new ResultViewModel
                    {
                        Message = "Nenhuma usuário foi encontrado com o ID informado!",
                        Success = true,
                        Data = user
                    });
                }
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                ...
                return Ok(new ResultViewModel
                {
                    Message = "Usuários encontrado coms sucesso!",
                    Success = true,
                    Data = allUsers
                });
            }
        ...
        public async Task<IActionResult> GetByEmail([FromQuery] string email)
        {
            try
            {
                ...
                if (user == null)
                {
                    return Ok(new ResultViewModel
                    {
                        Message = "Nenhuma usuário foi encontrado com o e-mail informado!",
                        Success = true,
                        Data = user
                    });
                }
        ...
        public async Task<IActionResult> SearchByName([FromQuery] string name)
        {
            try
            {
                ...
                if (allUsers.Count == 0)
                {
                    return Ok(new ResultViewModel
                    {
                        Message = "Nenhuma usuário foi encontrado com o nome informado!",
                        Success = true,
                        Data = null
                    });
                }
